...
>(({ className, inset = false, children }, ref) => (
...
function DropdownMenuShortcut({ className }: React.HTMLAttributes<HTMLSpanElement>) {
    return <span className={cn('ml-auto text-xs tracking-widest opacity-60', className)} />;
}
