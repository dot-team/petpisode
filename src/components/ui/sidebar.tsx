...
import { TooltipProvider, TooltipContent, Tooltip, TooltipTrigger } from './tooltip';
...
>(
    (
        ...
        const toggleSidebar = React.useCallback(() => {
            return isMobile ? setOpenMobile(opened => !opened) : setOpen(opened => !opened);
...
SidebarGroupLabel.defaultProps = {
    asChild: false,
};
...
SidebarGroupAction.defaultProps = {
    asChild: false,
};
